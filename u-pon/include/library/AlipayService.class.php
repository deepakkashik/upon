...
class AlipayService {
	...
	//构造支付宝外部服务接口控制
	function AlipayService($parameter,$security_code,$sign_type = "MD5",$transport= "https") {
	...
	function sign($prestr) {
		...
		if($this->sign_type == 'MD5') {
			...
			//DSA 签名方法待后续开发
			die(INCLUDE_LIARBRY_ALIPAYNOTIFY_NOTICE);
		}else {
			die(INCLUDE_LIARBRY_ALIPAYNOTIFY_NOT_SUPPORT.$this->sign_type.INCLUDE_LIARBRY_ALIPAYNOTIFY_SIGNATURE_TYPE);
		}
		return $mysign;
	}
