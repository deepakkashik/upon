...
var arrBlocktag=[{n:'p',t:'普通'},{n:'h1',t:'見出し1'},{n:'h2',t:'見出し2'},{n:'h3',t:'見出し3'},{n:'h4',t:'見出し4'},{n:'h5',t:'見出し5'},{n:'h6',t:'見出し6'},{n:'pre',t:'フォーマット済'},{n:'address',t:'アドレス'}];
var arrFontname=[{n:'ＭＳ ゴシック'},{n:'ＭＳ 明朝'},{n:'ＭＳ Ｐゴシック'},{n:'ＭＳ Ｐ明朝'},{n:'MS UI Gothic'},{n:'Arial'},{n:'Arial Narrow'},{n:'Arial Black'},{n:'Comic Sans MS'},{n:'Courier New'},{n:'System'},{n:'Times New Roman'},{n:'Tahoma'},{n:'Verdana'}];
var arrFontsize=[{n:'xx-small',wkn:'x-small',s:'8pt',t:'xx-小'},{n:'x-small',wkn:'small',s:'10pt',t:'x-小'},{n:'small',wkn:'medium',s:'12pt',t:'小'},{n:'medium',wkn:'large',s:'14pt',t:'中'},{n:'large',wkn:'x-large',s:'18pt',t:'大'},{n:'x-large',wkn:'xx-large',s:'24pt',t:'x-大'},{n:'xx-large',wkn:'-webkit-xxx-large',s:'36pt',t:'xx-大'}];
var menuAlign=[{s:'左揃え',v:'justifyleft',t:'左揃え'},{s:'中央揃え',v:'justifycenter',t:'中央揃え'},{s:'右揃え',v:'justifyright',t:'右揃え'},{s:'両端揃え',v:'justifyfull',t:'両端揃え'}],menuList=[{s:'段落番号',v:'insertOrderedList',t:'Ordered list'},{s:'箇条書き',v:'insertUnorderedList',t:'Unordered list'}];
var htmlPastetext='<div>「Ctrl+V」で貼り付ける.</div><div><textarea id="xhePastetextValue" wrap="soft" spellcheck="false" style="width:300px;height:100px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="OK" /></div>';
var htmlLink='<div>URL: <input type="text" id="xheLinkHref" value="http://" class="xheText" /></div><div>ターゲット:&nbsp;&nbsp; <select id="xheLinkTarget"><option selected="selected" value="">デフォルト</option><option value="_blank">新しいウィンド</option><option value="_self">同じウィンド</option><option value="_parent">親ウィンド</option></select></div><div style="display:none">リンクテキスト:<input type="text" id="xheLinkText" value="" class="xheText" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="OK" /></div>';
var htmlImg='<div>画像URL:&nbsp; <input type="text" id="xheImgSrc" value="http://" class="xheText" /></div><div>Altテキスト: <input type="text" id="xheImgAlt" /></div><div>揃え:<select id="xheImgAlign"><option selected="selected" value="">デフォルト</option><option value="left">左</option><option value="right">右</option><option value="top">上</option><option value="middle">中</option><option value="baseline">ベースライン</option><option value="bottom">底</option></select></div><div>サイズ:<input type="text" id="xheImgWidth" style="width:40px;" /> x <input type="text" id="xheImgHeight" style="width:40px;" /></div><div>枠:&nbsp;&nbsp;&nbsp;<input type="text" id="xheImgBorder" style="width:40px;" /></div><div>Hspace:&nbsp;&nbsp;&nbsp;<input type="text" id="xheImgHspace" style="width:40px;" /> Vspace:<input type="text" id="xheImgVspace" style="width:40px;" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="OK" /></div>';
var htmlFlash='<div>Flash URL:<input type="text" id="xheFlashSrc" value="http://" class="xheText" /></div><div>サイズ:<input type="text" id="xheFlashWidth" style="width:40px;" value="480" /> x <input type="text" id="xheFlashHeight" style="width:40px;" value="400" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="OK" /></div>';
var htmlMedia='<div>メディアURL:<input type="text" id="xheMediaSrc" value="http://" class="xheText" /></div><div>サイズ:<input type="text" id="xheMediaWidth" style="width:40px;" value="480" /> x <input type="text" id="xheMediaHeight" style="width:40px;" value="400" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="OK" /></div>';
var htmlTable='<div>行&列:&nbsp;&nbsp;<input type="text" id="xheTableRows" style="width:40px;" value="3" /> x <input type="text" id="xheTableColumns" style="width:40px;" value="2" /></div><div>ヘッダ:&nbsp;&nbsp;&nbsp;&nbsp;<select id="xheTableHeaders"><option selected="selected" value="">なし</option><option value="row">1行目</option><option value="col">1列目</option><option value="both">両方</option></select></div><div>サイズ:&nbsp;&nbsp;<input type="text" id="xheTableWidth" style="width:40px;" value="200" /> x <input type="text" id="xheTableHeight" style="width:40px;" value="" /></div><div>枠:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="xheTableBorder" style="width:40px;" value="1" /></div><div>間隔:<input type="text" id="xheTableCellSpacing" style="width:40px;" value="1" /> 余白:<input type="text" id="xheTableCellPadding" style="width:40px;" value="1" /></div><div>揃え:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<select id="xheTableAlign"><option selected="selected" value="">デフォルト</option><option value="left">左</option><option value="center">中央</option><option value="right">右</option></select></div><div>見出し:&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="xheTableCaption" /></div><div style="text-align:right;"><input type="button" id="xheSave" value="OK" /></div>';
var htmlAbout='<div style="font:12px Arial;width:245px;word-wrap:break-word;word-break:break-all;"><p><span style="font-size:20px;color:#1997DF;">xhEditor</span><br />v1.0.0 Final (build 100701)</p><p>xhEditorはjQueryをベースにしたXHTMLのエディタです。 <a href="http://www.gnu.org/licenses/lgpl.html" target="_blank">LGPL</a>に基づいたオープンソースです。</p><p>Copyright © <a href="http://xheditor.com/" target="_blank">xhEditor.com</a>. All rights reserved.</p></div>';
var itemEmots={'default':{name:'デフォルト',width:24,height:24,line:7,list:{'smile':'Smile','tongue':'Tongue','titter':'Titter','laugh':'Laugh','sad':'Sad','wronged':'Wronged','fastcry':'Fast cry','cry':'Cry','wail':'Wail','mad':'Mad','knock':'Knock','curse':'Curse','crazy':'Crazy','angry':'Angry','ohmy':'Oh my','awkward':'Awkward','panic':'Panic','shy':'Shy','cute':'Cute','envy':'Envy','proud':'Proud','struggle':'Struggle','quiet':'Quiet','shutup':'Shut up','doubt':'Doubt','despise':'Despise','sleep':'Sleep','bye':'Bye'}}};
var arrTools={Cut:{t:'切り取り (Ctrl+X)'},Copy:{t:'コピー (Ctrl+C)'},Paste:{t:'貼り付け (Ctrl+V)'},Pastetext:{t:'テキストで貼り付け',h:isIE?0:1},Blocktag:{t:'ブロックタグ',h:1},Fontface:{t:'フォント',h:1},FontSize:{t:'フォントサイズ',h:1},Bold:{t:'太字 (Ctrl+B)',s:'Ctrl+B'},Italic:{t:'斜体 (Ctrl+I)',s:'Ctrl+I'},Underline:{t:'下線 (Ctrl+U)',s:'Ctrl+U'},Strikethrough:{t:'棒線 (Ctrl+S)',s:'Ctrl+S'},FontColor:{t:'文字色',h:1},BackColor:{t:'背景色',h:1},SelectAll:{t:'全て選択 (Ctrl+A)'},Removeformat:{t:'フォーマット削除'},Align:{t:'揃え',h:1},List:{t:'リスト',h:1},Outdent:{t:'インデント解除 (Shift+Tab)',s:'Shift+Tab'},Indent:{t:'インデント (Tab)',s:'Tab'},Link:{t:'リンク挿入/編集',h:1},Unlink:{t:'リンク削除'},Img:{t:'画像挿入/編集',h:1},Flash:{t:'フラッシュ挿入/編集',h:1},Media:{t:'メディア挿入/編集',h:1},Emot:{t:'顔文字',s:'ctrl+e',h:1},Table:{t:'テーブル挿入',h:1},Source:{t:'ソース編集'},Print:{t:'印刷 (Ctrl+P)',s:'Ctrl+P'},Fullscreen:{t:'全画面 (Esc)',s:'Esc'},About:{t:'xhEditorについて'}};
var toolsThemes={
	mini:'Bold,Italic,Underline,Strikethrough,Separator,Align,List,Separator,Link,Img,About',
	simple:'Blocktag,Fontface,FontSize,Bold,Italic,Underline,Strikethrough,FontColor,BackColor,Separator,Align,List,Outdent,Indent,Separator,Link,Img,Source',
