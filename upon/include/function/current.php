...
function current_frontend() {
	global $INI;
	$a = array(
			'/index.php' => INCLUDE_FUNCTION_CURRENT_TODAY_TUANGOU,
...
function current_account($selector='/account/settings.php') {
	...
	$a = array(
		...
		'/account/creditcard.php' => INCLUDE_FUNCTION_CURRENT_ACCOUNT_CREDITCARD,
...
function current_template_sub($selector='template') {
	$selector = $selector ? $selector : 'template';
	$a = array(
		'/manage/system/template.php' => INCLUDE_FUNCTION_CURRENT_TEMPLATE,
		'/manage/system/template_m.php' => INCLUDE_FUNCTION_CURRENT_TEMPLATE_M,
	);
	$l = "/manage/system/{$selector}.php";
	return current_link($l, $a);
}
