...
if($team['partner_id'] != $partner_id) {
	Session::Set('error', BIZ_DOWN_CANNOT_ACCESS_DATA);
...
if ( $team['delivery']=='express' ) {
	...
	$kn = array(
		'email' => BIZ_DOWN_USER_EMAIL,
		'mobile' => BIZ_DOWN_MOBILE_NUMBER,
		'id' => $INI['system']['couponname'].BIZ_DOWN_IDENTIFIER,
	);
	if ( abs(intval($INI['system']['partnerdown']))) {
		$kn['secret'] = BIZ_DOWN_CONSUME_PASSWORD;
	}
