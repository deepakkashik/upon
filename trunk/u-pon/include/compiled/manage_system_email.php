	...
	<div id="content" class="clear mainwide">
        <div class="clear box">
            ...
            <div class="box-content">
                <div class="head"><h2>メールサーバー設定</h2></div>
                <div class="sect">
                    <form method="post">
						<div class="wholetip clear"><h3>1. 送信メールサーバー</h3></div>
						<div class="field">
							<label>サーバーの種類</label>
